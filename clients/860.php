...
if(!empty($tibiaspr))
{
	...
	$content[0x108F05] = chr(0x5D); $content[0x108F06] = chr(0x7A); $content[0x108F07] = chr(0x5B); $content[0x108F08] = chr(0x00);
...
if(isset($lighthack))
{
	$content[0xEAFA9] = chr(0x90);
	$content[0xEAFAA] = chr(0x90);
	$content[0xEAFAC] = chr(0xFF);
}
if(isset($mchack))
{
...
if(isset($xray))
{
	$content[0xF2809] = chr(0x90);
	$content[0xF280A] = chr(0x90);
	$content[0xF2813] = chr(0x90);
	$content[0xF2814] = chr(0x90);
}
if(isset($extfiles))
{
